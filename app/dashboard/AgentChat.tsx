  ...
  return (
    <AnimatePresence>
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 bg-black/70 backdrop-blur-md z-[10000] flex items-center justify-center p-4 scrollbar-hide"
        onClick={onClose}
      >
        <motion.div
          ...
          className="w-full max-w-xl bg-zinc-900 rounded-2xl shadow-2xl overflow-hidden flex flex-col h-[85vh] max-h-[800px] border border-zinc-800 z-[10001]"
