...
import { Wallet, Zap, CreditCard, Loader2 } from "lucide-react";
import { GridBackground } from "./GridBackground";

// Lazy load heavy component for better LCP
const TransactionSimulation = dynamic(
  () => import("./TransactionSimulation").then((mod) => mod.TransactionSimulation),
  {
    ssr: false,
    loading: () => (
      <div className="bg-card/50 backdrop-blur-md rounded-3xl border border-border p-10 min-h-[500px] flex items-center justify-center">
...
// Static step data moved outside component
const STEPS = [
  {
    step: "1",
    icon: Wallet,
